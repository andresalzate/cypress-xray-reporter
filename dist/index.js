    ...
    constructor(runner, options) {
        ...
        this._runner.on('suite', (suite) => {
            ...
            if (isInvalidSuite(suite)) {
                ...
                debug('running suite:', ((_a = suite) === null || _a === void 0 ? void 0 : _a.title) || (suite.root ? '[Root suite]' : '[Unknown suite]'));
        ...
        this._runner.on('suite end', (suite) => {
            var _a;
            debug('completed suite:', ((_a = suite) === null || _a === void 0 ? void 0 : _a.title) || (suite.root ? '[Root suite]' : '[Unknown suite]'));
